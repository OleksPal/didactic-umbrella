...
class FavouriteAdvertisement extends StatefulWidget {

  @override
  State<StatefulWidget> createState() => new _FavouriteAdvertisementState();
}

class _FavouriteAdvertisementState extends State<FavouriteAdvertisement> {
  ...
  Widget build(BuildContext context){
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: StreamBuilder(
            stream: FirebaseFirestore.instance.collection("items").where("favourite",isEqualTo: true).snapshots(),
            builder: (context, snapshot) {
              if(!snapshot.hasData) return Container(
                alignment: Alignment.center,
                child: Text("У вас пока нет любимых обьявлений",
